...
package de.ssp.ttr_rechner.ocr.textrecognition;
...
public class TextRecognitionProcessor extends VisionProcessorBase<FirebaseVisionText> {
    ...
    public FirebaseVisionText getResult()
    {
        return result;
    }
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < blocks.size(); i++) {
            ...
            Log.d(this.getClass().toString(), lines.toString());
            for (int j = 0; j < lines.size(); j++) {
                List<FirebaseVisionText.Element> elements = lines.get(j).getElements();
                Log.d(this.getClass().toString(), elements.toString());
                for (int k = 0; k < elements.size(); k++) {
                    ...
                    Log.d(this.getClass().toString(), text.getText());
                }
            }
        }
