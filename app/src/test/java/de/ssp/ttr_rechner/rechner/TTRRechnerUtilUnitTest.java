...
public class TTRRechnerUtilUnitTest
{
    ...
    {
        TTRRechnerUtil ttrRechnerUtil = new TTRRechnerUtil(1650, 16, null);
    ...
    public void testBerechneAenderungBeispielEinfach()
    {
        ...
        TTRRechnerUtil ttrRechnerUtil = new TTRRechnerUtil(1615, 16, matchArrayList);
        long ttrAenderung = ttrRechnerUtil.berechneTTRAenderung();
    ...
    public void testBerechneAenderungBeispielGroßerErfolg()
    {
        ...
        TTRRechnerUtil ttrRechnerUtil = new TTRRechnerUtil(1576, 16, matchArrayList);
    ...
    public void testBerechneAenderungBeispielKleineNiederlage()
    {
        ...
        TTRRechnerUtil ttrRechnerUtil = new TTRRechnerUtil(1662, 16, matchArrayList);
        long ttrAenderung = ttrRechnerUtil.berechneTTRAenderung();
    ...
    public void testBerechneAenderungBeispielAndereKonstante()
    {
        ...
        TTRRechnerUtil ttrRechnerUtil = new TTRRechnerUtil(1170, 24, matchArrayList);
        long ttrAenderung = ttrRechnerUtil.berechneTTRAenderung();
